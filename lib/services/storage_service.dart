...
class StorageService {
  ...
  static Future<void> saveRecord(SleepRecord record) async {
    ...
    // In questo design semplice, per ora li aggiungiamo e basta o rimuoviamo il vecchio.
    // Approccio migliore: se c'è già il record di "oggi", lo aggiorniamo.
    recordsJsonList.removeWhere((jsonStr) {
      final map = jsonDecode(jsonStr);
      return map['date'] == record.date;
    });

    // Aggiungi il nuovo record in cima (o in fondo, non importa, itereremo)
